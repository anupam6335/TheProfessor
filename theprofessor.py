...
path_label = Label(root, text="Select path to download",font='Helvetica 11 bold').place(x = 180, y = 130) 
path_button = Button(root, text='Select', width=10).place(x = 220, y = 160) 
